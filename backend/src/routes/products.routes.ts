...
import { addNewProduct, getProduct, getProducts, masterSwitch, updateProduct } from "../controllers/products.controller";
...
router.route('/get-one-product').post(getProduct)
