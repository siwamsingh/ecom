      ...
      <div className="max-w-screen-lg mx-auto min-h-[70vh] p-4 bg-white text-black">
        ...
        <div className="bg-yellow-50 rounded-xl p-4 flex items-center mb-6">
          ...
          <p className="text-sm text-yellow-900">
            ...
            <strong>paid and unpaid</strong> ones. <br />
            In case payment is done but it still shows unpaid{" "}
            <a
              href="/contact"
        ...
        {!loading ? (
          orders && orders.length > 0 ? (
            orders.map((order, index) => (
              <div
                key={index}
                className="rounded-lg mb-4 shadow-md bg-gray-100 text-black overflow-hidden"
              >
                ...
                {expandedOrder === order._id && (
                  <div className="px-4 pb-4 pt-1 border-t bg-slate-100 border-gray-300">
