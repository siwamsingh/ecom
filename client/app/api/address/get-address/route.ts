        ...
        async function getAddress(cookieHeader: string) {
        try {
            const response = await axios.post(`${serverUrl}/address/get-address`, {}, {
            headers: {
                Cookie: cookieHeader,
        ...
        try {
            ...
            { 
                success: false, 
                message: getErrorMsg(error, null, "fetching addresses")
            },
